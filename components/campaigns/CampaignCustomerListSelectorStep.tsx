...
import { TemplateSelectionCard } from './NewCampaignButton';
...
export const CustomerListSelectorStep = ({ 
    ...
    const handleSelection = useCallback((keys: Selection) => {
        ...
        const compatibilityResult = Boolean(
            selectedList &&
            requiredFieldNames.every((field) => listFields.includes(field))
        )
